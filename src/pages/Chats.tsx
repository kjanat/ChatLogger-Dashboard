            ...
            <div className="rounded-md bg-red-50 p-4 my-4">
                <div className="flex">
                    <div className="ml-3">
                        ...
                        {statusCode && (
                            <p className="text-xs text-red-600 mt-1">Status code: {statusCode}</p>
                        )}
                    </div>
                </div>
            </div>
        ...
        <div className="space-y-6">
            ...
            {filteredChats.length > 0 ? (
                    ...
                    {filteredChats.map((chat: Chat) => (
                        ...
                        >
                            <div className="flex justify-between">
                                <h3 className="text-lg font-medium text-gray-900 dark:text-white">{chat.title}</h3>
                ...
                <div className="text-center py-12 bg-gray-50 rounded-lg dark:bg-gray-800">
                    ...
                    <h3 className="mt-2 text-lg font-medium text-gray-900 dark:text-white">No chats found</h3>
                    <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        {search ? 'Try adjusting your search' : 'Start a new chat to get started'}
                    </p>
                    {!search && (
                        <div className="mt-6">
                            <Link
