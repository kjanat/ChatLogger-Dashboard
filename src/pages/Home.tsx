...
const features = [
  {
    name: 'Chat History',
    description:
      'Store and access your complete conversation history with AI assistants.',
    icon: ChatBubbleLeftRightIcon,
  },
  {
    name: 'Real-time Logging',
    description:
      'Log conversations as they happen with automatic synchronization.',
    icon: ClockIcon,
  },
  {
    name: 'Analytics',
    description:
      'Gain insights from your chat data with powerful analytics tools.',
    ...
    <div className="relative isolate overflow-hidden bg-white dark:bg-gray-900">
      ...
      <div className="mx-auto max-w-7xl px-4 pt-6 pb-16 sm:px-6 sm:pb-24 lg:flex lg:px-8 lg:py-32">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl lg:flex-shrink-0 lg:pt-8">
          ...
          <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 sm:leading-8 text-gray-600 dark:text-gray-300">
            A powerful platform for storing and retrieving chat interactions
            between users and AI assistants. Log, analyze, and export your chat
            data with ease.
          </p>
          <div className="mt-6 sm:mt-10 flex items-center gap-x-4 sm:gap-x-6">
            ...
            <Link
              to="/chats"
              className="text-sm font-semibold leading-6 text-gray-900 dark:text-white group flex items-center gap-x-1"
            >
              View chats
              <ArrowRightIcon
            ...
            <div className="rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4 dark:bg-gray-800/50 dark:ring-gray-700/30">
              <div className="relative w-full overflow-hidden">
                ...
                <div className="w-full overflow-hidden rounded-md shadow-2xl">
                  <img
                    src="https://fakeimg.pl/1200x800/2563eb/ffffff?text=ChatLogger+Dashboard&font=noto&font_size=60"
      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-primary-600 dark:text-white">
            Everything you need
          </h2>
          ...
          <p className="mt-4 sm:mt-6 text-base sm:text-lg leading-7 text-gray-600 dark:text-gray-300">
            ChatLogger provides a comprehensive set of tools to help you manage,
            analyze, and leverage your chat data effectively.
          </p>
        </div>
            ...
            {features.map((feature) => (
              <div key={feature.name} className="flex flex-col">
                <dt className="flex items-center gap-x-3 text-base font-semibold leading-7 text-gray-900 dark:text-white">
                  <feature.icon
                    className="h-5 w-5 flex-none text-primary-600 dark:text-white"
                    aria-hidden="true"
                  />
                  {feature.name}
                </dt>
